...
The sine solutions move really slowly, why do they move so slow? How much faster does the Sine2 solution move with respect to Sine1? Or phrased differently, what do you get when you divide the frequency of Sine2 by the frequency Sine1? You can use E=h*f for this. Now set the display to |psi|^2, which you know as probability density. Sine1 and Sine2 are stationary states, why? Why is Sine12 not a stationay state?
<br><br>
